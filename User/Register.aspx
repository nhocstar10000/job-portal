<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="job_portal.User.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section>
        <div class="container pt-50 pb-40">
         ...
         <div class="col-12">
             <h2 class="contact-title text-capitalize">Sign Up</h2>
         </div>
         <div class="col-lg-6 mx-auto">
             <div class="form-contact contact_form">
                 <div class="row">
                     ...
                     <div class="col-sm-6">
                         <div class="form-group">
                             ...
                             <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password and Confirm Password shoule be same" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Font-Size="Small"></asp:CompareValidator>
                     ...
                     <div class="col-12">
                         <div class="form-group">
                             ...
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Country is required" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Font-Size="Small" InitialValue="0" ControlToValidate="dd1Country"></asp:RequiredFieldValidator>
                 ...
                 <div class="form-group mt-3">
                     ...
                     <span class="clickLink"><a href="../User/Login.aspx">Have Account? CLick Here</a></span>
                 </div>
