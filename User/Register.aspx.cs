    ...
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Country", dd1Country.SelectedValue);
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Can't save record right now, please try after sometime! ";
