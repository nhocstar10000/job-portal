<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="job_portal.Admin.Dashboard" %>
                        ...
                        <div class="card l-bg-orange-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row-align-item-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-item-center mb-0">
                                            <% Response.Write(Session["Contract"]); %>
                                        </h2>
                                    </div>
                                </div>
                            </div>
